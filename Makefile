...
libfish.a_SRCS = dim.cpp error.cpp error_map.cpp intensify.cpp io.cpp misc.cpp poissonify.cpp rebin.cpp rotate.cpp scale.cpp split.cpp translate.cpp tinytiffwriter.cpp
